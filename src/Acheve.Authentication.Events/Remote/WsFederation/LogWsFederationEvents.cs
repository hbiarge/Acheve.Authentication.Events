...
namespace Microsoft.AspNetCore.Authentication
{
    ...
    public class LogWsFederationEvents<TOther> : LogWsFederationEvents where TOther : WsFederationEvents
    {
        private readonly TOther _originalEvents;

        public LogWsFederationEvents(IOptionsMonitor<WsFederationOptions> options, TOther originalEvents, ILogger<LogWsFederationEvents> logger)
            : base(options, logger)
        {

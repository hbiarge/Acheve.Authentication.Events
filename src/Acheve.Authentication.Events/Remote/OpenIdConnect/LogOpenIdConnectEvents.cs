...
public class LogOpenIdConnectEvents(
    IOptionsMonitor<OpenIdConnectOptions> options,
    ILogger<LogOpenIdConnectEvents> logger) : OpenIdConnectEvents
{
    private readonly IOptionsMonitor<OpenIdConnectOptions> _options = options;
    private readonly ILogger<LogOpenIdConnectEvents> _logger = logger;
...
public class LogOpenIdConnectEvents<TOther>(
    IOptionsMonitor<OpenIdConnectOptions> options,
    TOther originalEvents,
    ILogger<LogOpenIdConnectEvents> logger)
    : LogOpenIdConnectEvents(options, logger)
    where TOther : OpenIdConnectEvents
{

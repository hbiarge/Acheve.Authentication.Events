...
public class LogGoogleEvents(
    IOptionsMonitor<GoogleOptions> options,
    ILogger<LogGoogleEvents> logger) : OAuthEvents
{
    private readonly IOptionsMonitor<GoogleOptions> _options = options;
    private readonly ILogger<LogGoogleEvents> _logger = logger;
...
public class LogGoogleEvents<TOther>(
    IOptionsMonitor<GoogleOptions> options,
    TOther originalEvents,
    ILogger<LogGoogleEvents> logger)
    : LogGoogleEvents(options, logger)

...
public class LogFacebookEvents(
    IOptionsMonitor<FacebookOptions> options,
    ILogger<LogFacebookEvents> logger) : OAuthEvents
{
    private readonly IOptionsMonitor<FacebookOptions> _options = options;
    private readonly ILogger<LogFacebookEvents> _logger = logger;
...
public class LogFacebookEvents<TOther>(
    IOptionsMonitor<FacebookOptions> options,
    TOther originalEvents,
    ILogger<LogFacebookEvents> logger)
    : LogFacebookEvents(options, logger)
